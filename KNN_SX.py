...
# Results
print("Best KNeighborsRegressor with Optimized Parameters:")
print(f"Best parameters: {best_params}")
print(f"Testing - R2: {r_squared:.4f}, MAE: {mae:.4f}, RMSE: {rmse:.4f}, MSE: {mse:.4f}, AARD: {aard:.4f}%")
print(f"Training - R2: {train_r_squared:.4f}, MAE: {train_mae:.6f}, RMSE: {train_rmse:.6f}, MSE: {train_mse:.6f}, AARD: {train_aard:.4f}%")
...
plt.title("Best Model Performance with KNeighborsRegressor")
